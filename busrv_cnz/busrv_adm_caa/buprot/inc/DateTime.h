...
// inlines
//===========================================================================
inline DateTime::DateTime(const DateTime& st)
{
    set(st.m_year, st.m_month, st.m_day, st.m_daylight, st.m_hour, st.m_minute, st.m_second);
}
//
//
// inlines
//===========================================================================
inline DateTime DateTime::operator=(const DateTime& st)
{
    set(st.m_year, st.m_month, st.m_day, st.m_daylight, st.m_hour, st.m_minute, st.m_second);
    return *this;
}
