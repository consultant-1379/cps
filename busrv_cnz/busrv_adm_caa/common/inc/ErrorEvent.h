...
Revision history
----------------
2011-05-30 xquydao Update for APG43L project
*/
#include "Exception.h"
...
public:
	//
	// ERROR_CODE_BASE + (BUSRV) ERROR_CODE == Specific Problem according to ACS_AEH...
	//----------------------------------------------------------------------
	// start at 22100 for BUSRV, at 22150 for CodeExceptions
