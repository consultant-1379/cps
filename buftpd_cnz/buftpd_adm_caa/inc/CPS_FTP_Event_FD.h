...
Revision history
----------------
2011-14-07 xquydao Created (The content of this file is taken from TOCAP)

*/
#ifndef CPS_FTP_EVENT_FD_H_
#define CPS_FTP_EVENT_FD_H_
...
class CPS_FTP_Event_FD : private boost::noncopyable {
...
public:
    ...
    CPS_FTP_Event_FD() : mState(INVALID), mError(0), mFd(-1) {
        int ret = eventfd(0, 0);
        if ( ret == -1) {
            mError = errno;
