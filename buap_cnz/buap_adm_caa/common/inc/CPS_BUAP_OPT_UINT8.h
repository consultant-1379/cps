...
// 
// .NAME
//  	CPS_BUAP_OPT_UINT8 - Container for AXE unsigned 8 bit integer
// .LIBRARY 3C++
// .PAGENAME CPS_BUAP_OPT_UINT8
// .HEADER  CPS  
...
#ifndef CPS_BUAP_OPT_UINT8_H
#define CPS_BUAP_OPT_UINT8_H

#include "CPS_BUAP_Buffer.h"


class CPS_BUAP_OPT_UINT8
{
public:
  ...
  CPS_BUAP_OPT_UINT8(unsigned char ch);
  // Description:
  // 	Class constructor
  // Parameters: 
  //    ch			value, in
  ...
  CPS_BUAP_OPT_UINT8& operator<<(unsigned char ch);
  // Description:
  // 	Input operator
  // Parameters: 
  //    ch			character to be added to the buffer, in
  // Return value: 
  //    CPS_BUAP_OPT_UINT8&	reference to this class
  // Additional information:
  //    -
  ...
  CPS_BUAP_OPT_UINT8& operator<<(CPS_BUAP_Buffer& buf);
  // Description:
