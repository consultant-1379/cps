...
// 
// .NAME
//  	CPS_BUAP_MSG_lock_reply - AP->AP Set lock on reladmpar file
// .LIBRARY 3C++
// .PAGENAME CPS_BUAP_MSG_lock_reply
// .HEADER  CPS  
...
#ifndef CPS_BUAP_MSG_lock_reply_H
#define CPS_BUAP_MSG_lock_reply_H
...
class CPS_BUAP_MSG_lock_reply : public CPS_BUAP_MSG
{
public:
  ...
  CPS_BUAP_UINT8      m_LockSetting;		// lock setting
  ...
  virtual ~CPS_BUAP_MSG_lock_reply();
  // Description:
  // 	Class destructor
  // Parameters: 
  // Return value: 
