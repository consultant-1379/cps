...
//
// NAME
//      %File_name:CPS_BUAP_OPT_UINT8.C%
//
...
//	Constructor()
//******************************************************************************
CPS_BUAP_OPT_UINT8::CPS_BUAP_OPT_UINT8()
{
  //newTRACE(("CPS_BUAP_OPT_UINT8::CPS_BUAP_OPT_UINT8()", 0))
...
//	Constructor()
//******************************************************************************
CPS_BUAP_OPT_UINT8::CPS_BUAP_OPT_UINT8(unsigned char ch)
{
  //newTRACE(("CPS_BUAP_OPT_UINT8::CPS_BUAP_OPT_UINT8(ch=%d", 0, ch))
...
//	operator<<
//******************************************************************************
CPS_BUAP_OPT_UINT8& CPS_BUAP_OPT_UINT8::operator<<(unsigned char ch)
{
  //newTRACE(("CPS_BUAP_OPT_UINT8::operator<<", 0))
...
//	operator<<
//******************************************************************************
CPS_BUAP_OPT_UINT8& CPS_BUAP_OPT_UINT8::operator<<(CPS_BUAP_Buffer& buf)
{
  //newTRACE(("CPS_BUAP_OPT_UINT8::operator<<", 0))
